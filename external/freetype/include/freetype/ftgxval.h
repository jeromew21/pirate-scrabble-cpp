...
#define FT_VALIDATE_GX  ( FT_VALIDATE_feat | \
   ...
   * @values:
   *    FT_VALIDATE_MS ::
   *      HandleContactEvents the 'kern' table as a classic Microsoft kern table.
   *
   *    FT_VALIDATE_APPLE ::
   *      HandleContactEvents the 'kern' table as a classic Apple kern table.
   *
   *    FT_VALIDATE_CKERN ::
   *      HandleContactEvents the 'kern' as either classic Apple or Microsoft kern table.
   */
